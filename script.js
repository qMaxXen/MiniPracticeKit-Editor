  ...
  hotbarDropdownBtn.addEventListener('click', (e) => {
    ...
    if (isVisible) {
      ...
      setTimeout(() => {
        ...
        if (hotbarTooltip && hotbarDropdownBtn.matches(':hover')) {
          hotbarTooltip.classList.add('show');
        } else if (hotbarTooltip) {
          hotbarTooltip.classList.remove('show');
        }
      }, 10);
    }
  });
...
loadDefaultHotbar();
showSuccessNotification('Successfully loaded the default hotbar.nbt!');
